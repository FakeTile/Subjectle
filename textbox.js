const studentNames = ['Abdulmohimen T', 'Addyson G', 'Aidan D', 'Ajdin D', 'Alan D', 'Alex S', 'Alicia S', 'Alyssa S', 'Angel A', 'Angelyn W', 'Anouk M', 'Arva B', 'Ashley N', 'Augie F', 'Axl H', 'Ben H', 'Byron H', 'Caleb D', 'Calvin J', 'Catalina P', 'Charlie N', 'Cooper F', 'Dane C', 'Dylan P', 'Eileen Z', 'Elizabeth A', 'Evan M', 'Finn D', 'Finn A', 'Fox L', 'Gwendolen T', 'Hamish M', 'Hamish N', 'Hannah M', 'Harrison S', 'Henry S', 'Holly P', 'Ilira V', 'Ingrid S', 'Isabel J', 'Isabella H', 'Izakk C', 'Jackson B', 'Jai M', 'Jayanth S', 'Jethro C', 'Johnny B', 'Josie H', 'Justin L', 'Kane G', 'Katherine L', 'Katie D', 'Kiah V', 'Larissa R', 'Lars A', 'Leki D', 'Lily B', 'Luke T', 'Marley N', 'Marlon M', 'Matthew E', 'Max H', 'Melody M', 'Milly D', 'Mollie F', 'Nancy L', 'Narelle B', 'Nat M', 'Ned M', 'Neil J', 'Nina M', 'Nyx B', 'Oliver E', 'Oliver S', 'Oscar S', 'Renu V', 'Rhys B', 'Riley G', 'Robert S', 'Ronan G', 'Ronin N', 'Rory M', 'Rosie V', 'Samuel P', 'Sarah S', 'Savannah H', 'Sean M', 'Sebin P', 'Soham M', 'Soli B', 'Tahlia R', 'Tijana P', 'Til C', 'Tilly F', 'Tilly M', 'Victor V', 'Victoria H', 'William Y', 'William M', 'William Z', 'William J', 'William B', 'William W', 'Zoe D', 'Rayan R', 'Ciaran S', 'Anh N', ];
