...
'Chloe B': ['Jones-ext', 'Penn-ext', 'Richmond', 'Marsh', 'Smith', 'Naito', 'Free', 'Jones-ext', ],
...
'Hamish M': ['Free', 'Penn-ext', 'Richmond', 'Heka', 'Limbrey', 'Moller', 'Treleaven-ext', 'Offner', ],
...
'Henry S': ['Weekes', 'Richmond', 'Richmond', 'Milnes', 'Free', 'Phelps-anc', 'Doyle', 'Doyle', ],
...
'Isabel J': ['Free', 'Phelps', 'Richmond', 'Milnes', 'Parkinson', 'Phelps-anc', 'Treleaven-ext', 'Free', ],
...
'Kane G': ['Vyas-ext', 'White', 'Richmond', 'Milnes', 'Smith', 'Groves', 'Free', 'Vyas-ext', ],
...
'Larissa R': ['Weekes', 'Court', 'Richmond', 'Free', 'Parkinson', 'Moller', 'Treleaven-ext', 'Offner', ],
...
'Rory M': ['Weekes', 'Treleaven-ext', 'Richmond', 'Milnes', 'Free', 'Moller', 'Penn-ext', 'Offner', ],
