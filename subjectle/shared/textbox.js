const studentNames = ['Aarez K', 'Abdulmohimen T', 'Addyson G', 'Aidan D', 'Ajdin D', 'Alan D', 'Alex S', 'Alice C', 'Alicia S', 'Alyssa S', 'Angel A', 'Angelyn W', 'Anh N', 'Anouk M', 'Arva B', 'Ashley N', 'Augie F', 'Axl H', 'Ben H', 'Ben I', 'Bonnie D', 'Byron H', 'Calvin J', 'Catalina P', 'Charlie N', 'Nyx B', 'Ciaran S', 'Cooper F', 'Dane C', 'Dylan P', 'Eileen Z', 'Elizabeth A', 'Evan M', 'Finn A', 'Finn D', 'Fox L', 'Freya K', 'Giselle M', 'Gwendolen T', 'Hamish M', 'Hamish N', 'Hannah M', 'Harrison S', 'Henry S', 'Holly P', 'Ilira V', 'Ingrid S', 'Innocent N', 'Isabel J', 'Isabella H', 'Izakk C', 'Jackson B', 'Jai M', 'Jayanth S', 'Jethro C', 'Johnny B', 'Jonathan C', 'Josie H', 'Justin L', 'Kane G', 'Katherine L', 'Katie D', 'Kiah V', 'Larissa R', 'Lars A', 'Leah S', 'Leki D', 'Lily B', 'Luke T', 'Marcus K', 'Marley N', 'Marlon M', 'Matthew E', 'Max H', 'Melody M', 'Milly D', 'Mollie F', 'Nancy L', 'Narelle B', 'Nat M', 'Ned M', 'Neil J', 'Nina M', 'Caleb D', 'Oliver E', 'Oliver S', 'Oscar S', 'Rayan M', 'Renu V', 'Rhys B', 'Riley G', 'Robert S', 'Ronan G', 'Ronin N', 'Rory M', 'Rosie V', 'Samuel P', 'Sarah S', 'Savannah H', 'Scarlett N', 'Sean M', 'Sebin P', 'Soham M', 'Soli B', 'Subhaan U', 'Tahlia R', 'Tijana P', 'Til C', 'Tilly F', 'Tilly M', 'Victor V', 'Victoria H', 'William B', 'William J', 'William M', 'William W', 'William Y', 'William Z', 'Zoe D'];
/* 
 *
